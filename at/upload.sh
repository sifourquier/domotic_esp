...
/opt/Espressif/esptool-py/esptool.py --port /dev/ttyUSB0 write_flash 0x40000 eagle.app.v6.irom0text.bin 0x00000 ../../../../../bin/eagle.flash.bin 0x7C000 ../../../../../bin/esp_init_data_default.bin 0x7E000 ../../../../../bin/blank.bin
