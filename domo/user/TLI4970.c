...
inline int TLI4970_get_curent()
{   
	bool transfer_succeeded = true;
	int reply;

	//spi_init(HSPI,9); //configure SPI 1=20MHZ 2=10MHZ 20=2MHZ
	...
	if(reply&(1<<15)) //lit jusque a avoir le courant
		return 0;
...
{
#ifndef V1_DEBUG_TLI
	gpio_output_set(0, BIT_TLI, BIT_TLI, 0); //nCS a 0 pour ne pas alimenter le composant par CS
	gpio16_output_set(1);
#endif
}
