...
void ICACHE_FLASH_ATTR disable_uart()
{
		CLEAR_PERI_REG_MASK(UART_INT_ENA(0), UART_RXFIFO_FULL_INT_ENA); //plus d'irq pour l'uart
		CLEAR_PERI_REG_MASK(UART_INT_ENA(1), UART_RXFIFO_FULL_INT_ENA); //plus d'irq pour l'uart
}
