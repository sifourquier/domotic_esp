...
LOCAL unsigned char m_nLastSDA;
LOCAL unsigned char m_nLastSCL;

void i2c_master_wait(unsigned int x)
{
...
i2c_master_setDC(unsigned char SDA, unsigned char SCL)
{
    SDA	&= 0x01;
    SCL	&= 0x01;
    m_nLastSDA = SDA;
...
i2c_master_start(void)
{
    ...
    i2c_master_wait(5);
    i2c_master_setDC(1, 1);
    i2c_master_wait(45);	// sda 1, scl 1
...
*******************************************************************************/
void ICACHE_FLASH_ATTR
i2c_master_setAck(unsigned char level)
{
...
*******************************************************************************/
void ICACHE_FLASH_ATTR
i2c_master_writeByte(unsigned char wrdata)
{
    unsigned char dat;
    sint8 i;
